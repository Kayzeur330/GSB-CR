...
class Praticien extends Modele {
    ...
    private $sqlPraticien = 'select id_praticien as idPraticien,nom_praticien as nomPraticien, prenom_praticien as prenomPraticien, adresse_praticien as adressePraticien, cp_praticien as cpPraticien, ville_praticien as villePraticien,coef_notoriete as coefPraticien, lib_type_praticien as libtypePraticien from PRATICIEN P join TYPE_PRATICIEN T on P.id_type_praticien=T.id_type_praticien';
